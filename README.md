...
<head>
    ...
    <style>
        ...
        header {
            background-color: #ffffff; /* rojo vino */
            color: #8b0000;
            padding: 10px;
            text-align: center;
        }
        ...
        #Inicio {
            display: block; /* Mostrar la pantalla principal inicialmente */
        }
        footer {
            background: #800020; /* Rojo vino */
            color: #fff;
            text-align: center;
            padding: 30px 0;
            margin-top: 20px;
...
<body>
    ...
    <div id="mision-vision" class="content">
